...
for row in rows:
    ...
    if isinstance(mm_id, int):
        ...
        insert_snake = ("INSERT INTO morphmarket"
                        "(mm_id, images_html, images, snake_title, snake_internal_id, snake_price, snake_url, "
                        ...
                        "VALUES "
                         "(%(mm_id)s, %(images_html)s, %(images)s, %(snake_title)s, %(snake_internal_id)s, %(snake_price)s, %(snake_url)s, "
